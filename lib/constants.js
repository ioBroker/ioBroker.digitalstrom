module.exports = {
    ...
    availableEvents: {
        'buttonClick': true, //
        'buttonDeviceAction': true,
        'deviceSensorEvent': true, //
        'deviceBinaryInputEvent': true, // Never seen
        'deviceActionEvent': true,
        'deviceEventEvent': true,
        'callScene': true, // DONE
        'callSceneBus': false,
        'undoScene': true, // DONE
        ...
        'heating_mode_switch': true,
        'building_service': false,
        'action_execute': false,
        'highlevelevent': true,
        'model_ready': true, // real startup done, reinit!!
        'running': false, // startup
        'blink': false, // irrelevant
        'deviceSensorValue': true, // DONE
        'deviceStateEvent': true,
        'zoneSensorValue': true, // DONE
        'executionDenied': true,
        'operation_lock': true,
        'cluster_config_lock': true,
        'devices_first_seen': true,
        'scene_name_changed': true,
        'dsMeter_ready': true, // reinit!
        'system_trigger': true,
        'heating-controller.operation-mode': true // OpenHab
    },
    ...
    sensorUnitRoleMap: {
        66: {name: 'Temperature', role: 'value.temperature', unit: 'K'}, // Temperature, Kelvin (K)
        68: {name: 'Relative Humidity', role: 'value.humidity', unit: '%'}, // Relative Humidity, Percent (%)
        67: {name: 'Brightness', role: 'value.brightness', unit: 'Lx'}, // Brightness, Lux (Lx)
        25: {name: 'Sound Pressure Level', role: 'value', unit: 'dB'}, // Sound Pressure Level, dB
        4: {name: 'Active Power', role: 'value', unit: 'W'}, // Active Power, Watt (W)
        65: {name: 'Apparent Power', role: 'value', unit: 'VA'}, // Apparent Power, Volt-Ampere (VA)
        5: {name: 'Output Current', role: 'value.current', unit: 'mA'}, // Output Current, Ampere (mA)
        64: {name: 'Output Current (High Range)', role: 'value.current', unit: 'mA'}, // Output Current (High Range), Ampere (mA)
        6: {name: 'Energy Meter', role: 'value.power.consumption', unit: 'kWh'}, // Energy Meter, Watthours (kWh)
        69: {name: 'Generated Active Power', role: 'value', unit: 'W'}, // Generated Active Power, Watt (W)
        70: {name: 'Generated Energy Meter', role: 'value', unit: 'kWh'}, // Generated Energy Meter, Watthours (kWh)
        71: {name: 'Water Quantity', role: 'value', unit: 'l'}, // Water Quantity, Liter (l)
        72: {name: 'Water Flow Rate', role: 'value', unit: 'l/s'}, // Water Flow Rate, Liter/Second (l/s)
        73: {name: 'Length', role: 'value', unit: 'm'}, // Length, Meter (m)
        74: {name: 'Mass', role: 'value', unit: 'g'}, // Mass, Gram (g)
        75: {name: 'Time', role: 'value', unit: 's'}, // Time, Second (s)
        9: {name: 'Room Temperature', role: 'value.temperature', unit: 'K'}, // Room Temperature, Kelvin (K)
        13: {name: 'Room Relative Humidity', role: 'value.humidity', unit: '%'}, // Room Relative Humidity, Percent (%)
        11: {name: 'Room Brightness', role: 'value.brightness', unit: 'Lx'}, // Room Brightness, Lux (Lx)
        21: {name: 'Room Carbon Dioxide CO2 Concentration', role: 'value.co2', unit: 'ppm'}, // Room Carbon Dioxide CO2 Concentration, ppm
        22: {name: 'Room Carbon Monoxide CO Concentration', role: 'value.co2', unit: 'ppm'}, // Room Carbon Monoxide CO Concentration, ppm
        50: {name: 'Room Temperature Set Point', role: 'level.temperature', unit: 'K'}, // Room Temperature Set Point, Kelvin (K)
        51: {name: 'Room Temperature Control Variable', role: 'level', unit: '%'}, // Room Temperature Control Variable, Percent (%)
        10: {name: 'Outdoor Temperature', role: 'value.temperature', unit: 'K'}, // Outdoor Temperature, Kelvin (K)
        14: {name: 'Outdoor Relative Humidity', role: 'value.humidity', unit: 'K'}, // Outdoor Relative Humidity, Percent (%)
        12: {name: 'Outdoor Brightness', role: 'value.brightness', unit: 'Lx'}, // Outdoor Brightness, Lux (Lx)
        15: {name: 'Air pressure', role: 'value.pressure', unit: 'hPa'}, // Air pressure, Pascal (hPa)
        16: {name: 'Wind gust speed', role: 'value.speed.wind.gust', unit: 'm/s'}, // Wind gust speed, m/s
        17: {name: 'Wind gust direction', role: 'value.direction.wind', unit: '°'}, // Wind gust direction, degrees
        18: {name: 'Wind speed (average)', role: 'value.speed.wind', unit: 'm/s'}, // Wind speed (average), m/s
        19: {name: 'Wind direction', role: 'value.direction.wind', unit: '°'}, // Wind direction, degrees
        20: {name: 'Precipitation intensity of last hour', role: 'value.precipitation.hour', unit: 'mm/m2'}, // Precipitation intensity of last hour, mm/m2
        60: {
    ...
    binaryInputTargetGroupNames: {
        8: 'Joker',
        64: 'Apartment Ventilation' // only Malfunction/Service
    },
