module.exports = {
    ...
    sensorUnitRoleMap: {
        66: {name: 'Temperature', role: 'value.temperature', unit: '°C'}, // Temperature, Kelvin (K)
        ...
        9: {name: 'Room Temperature', role: 'value.temperature', unit: '°C'}, // Room Temperature, Kelvin (K)
        ...
        50: {name: 'Room Temperature Set Point', role: 'level.temperature', unit: '°C'}, // Room Temperature Set Point, Kelvin (K)
        51: {name: 'Room Temperature Control Variable', role: 'level', unit: '%'}, // Room Temperature Control Variable, Percent (%)
        10: {name: 'Outdoor Temperature', role: 'value.temperature', unit: '°C'}, // Outdoor Temperature, Kelvin (K)
        14: {name: 'Outdoor Relative Humidity', role: 'value.humidity', unit: '°C'}, // Outdoor Relative Humidity, Percent (%)
